...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('sfProfileForm')?.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (result.ok) {
                window.location.href = base + '/index.php?page=profile&notice=profile_updated';
            } else {
                alert(result.error || 'Virhe tallennuksessa');
            }
        } catch (err) {
    ...
    document.getElementById('sfPasswordForm')?.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (result.ok) {
                window.location.href = base + '/index.php?page=profile&notice=password_changed';
            } else {
                alert(result.error || 'Virhe salasanan vaihdossa');
            }
        } catch (err) {
            console.error('Password change error:', err);
            alert('Virhe salasanan vaihdossa');
        }
    });
});
</script>