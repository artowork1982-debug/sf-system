...
$noticeData = [
    ...
    'bulk_deleted'      => ['msg_key' => 'notice_bulk_deleted',      'type' => 'success'],
        'worksite_added'     => ['msg_key' => 'notice_worksite_added',     'type' => 'success'],
    'worksite_enabled'   => ['msg_key' => 'notice_worksite_enabled',   'type' => 'success'],
    'worksite_disabled'  => ['msg_key' => 'notice_worksite_disabled',  'type' => 'info'],
];
